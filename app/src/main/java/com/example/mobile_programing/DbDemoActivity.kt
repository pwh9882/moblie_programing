...
class DbDemoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //루틴 생성(추가 카드없음)
        var routine1: Routine = Routine("","운동",0, 0,"description1",listCard)
        var routine2: Routine = Routine("","코딩",0, 0,"description2",listCard)
        var routine3: Routine = Routine("","음식",0, 0,"description3",listCard)
        //처음 생성한 루틴 저장
...
//        }
        ...
        GlobalScope.launch {
            var newRoutine: Routine = Routine("", "러닝", 10, 0,"description4", listCard)
